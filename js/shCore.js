...
var SyntaxHighlighter = function () {
    ...
    function p(a, b, c) {
        ...
        var d = c != true ? a.childNodes : [a.parentNode],
            ...
            g, i;g = h != "nodeName" ? b.substr(1) : b.toUpperCase();
    ...
    e.Highlighter.prototype = {
        ...
        getCodeLinesHtml: function (a, b) {
            ...
            for (var h = this.getParam("brush"), g = 0; g < c.length; g++) {
                ...
                i = x(i);
                if (i.length == 0) i = e.config.space;a += this.getLineHtml(g, l, (j != null ? '<code class="' + h + ' spaces">' + j + "</code>" : "") + i)
            }
            return a
        },
